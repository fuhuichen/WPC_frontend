    ...
    public async GetLocationList(datas): Promise<any> {
        try {
            let body: object = {
                ...
                pageIndex: datas.paging.page,
                pageSize: datas.paging.pageSize,
                locationName: !datas.location ? null : datas.location.key === '' ? null : datas.location.key,
                type: !datas.type ? null : datas.type.key === '' ? null : datas.type.key,
            };
    ...
    public async GetCourseList(datas): Promise<any> {
        try {
            let body: object = {
                ...
                pageIndex: datas.paging.page,
                pageSize: datas.paging.pageSize,
                bgName: !datas?.bgName ? null : datas.bgName.key === '' ? null : datas.bgName.key,
                sectorName: !datas?.sectorName ? null : datas.sectorName.key === '' ? null : datas.sectorName.key,
            };
